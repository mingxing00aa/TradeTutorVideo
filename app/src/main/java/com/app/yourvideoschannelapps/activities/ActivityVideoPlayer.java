...
import com.app.yourvideoschannelapps.utils.TrackSelectionDialog;
...
public class ActivityVideoPlayer extends AppCompatActivity {
    ...
    public void closePlayer() {
        if (AppConfig.PRESS_BACK_TWICE_TO_CLOSE_PLAYER) {
            if ((System.currentTimeMillis() - exitTime) > 2000) {
                Snackbar.make(findViewById(R.id.root_view), getString(R.string.press_again_to_close_player), Snackbar.LENGTH_SHORT).show();
